...
<section class="content-header">
  ...
  'label' => false,'div' => false,)));?>
    ...
    <div class="col-sm-5">
                     <?= $this->Form->control('description', array('label' => false,'placeholder'=>'Description','class'=>'form-control')); ?>
                  </div>
                </div>
                <div class="form-group">
    ...
    <div class="col-sm-5">
                     <?= $this->Form->control('product_image', array('type' => 'file','label' => false,'class'=>'form-control')); ?>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
