      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <?= $this->Form->create('empolyes', array('class' => 'form-horizontal','inputDefaults' => array(
  'label' => false,'div' => false,)));?>
    ...
    <div class="col-sm-5">
                     <?= $this->Form->control('email', array('label' => false,'placeholder'=>'Email','class'=>'form-control','value' => '' )); ?>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"><?= __('Father Name'); ?></label>
    <div class="col-sm-5">
                     <?= $this->Form->control('father_name', array('label' => false,'placeholder'=>'Father Name','class'=>'form-control','value' => '' )); ?>
                  </div>
                </div>
